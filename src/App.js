...
import {
  thunk_action_creator_issues,
  thunk_action_creator_issue_count
  ...
  render() {
    ...
    return (
      <div className="container">
        {Object.keys(this.props.data.issues.userData).length > 0 ? null : this
          .props.data.issues.isFetching ? null : (
        ...
        {Object.keys(this.props.data.issues.userData).length > 0 ? (
          <IssueList
            user={this.props.data.issues.userData}
            count={this.props.data.issues.issueCount}
          />
